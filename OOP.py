...
As discussed in today's Class, this code will attempt to showcase the concepts of OOP as implemented in Python,
 Notice we have 3 classes in this code, One super class and two children/subclasses .
...
if __name__ == "__main__":
    ...
    print(">>> Discounted Cart Contents <<<")
